...
function dbm_study_dremel() {
  ...
  MATERIALIZE '/cns/ig-d/home/aredakov/david_dbm_propencities/ga_remarket_list_ids/data@1' AS
  ...
  MATERIALIZE '/cns/ig-d/home/aredakov/david_dbm_propencities/advertisers_revenue_xbid/data@5000' AS
  SELECT
  ...
  MATERIALIZE '/cns/ig-d/home/aredakov/david_dbm_propencities/advertisers_nonadx_revenue/data@5000' AS
  SELECT
    xbid_dimensions.xbid_advertiser_id AS advertiser_id,
  ...
  MATERIALIZE '/cns/ig-d/home/aredakov/david_dbm_propencities/advertisers_adx_revenue/data@5000' AS
  SELECT
    xbid_dimensions.xbid_advertiser_id AS advertiser_id,
  ...
  DEFINE TABLE nonadx_revenue /cns/ig-d/home/aredakov/david_dbm_propencities/advertisers_nonadx_revenue/data*;
  DEFINE TABLE adx_revenue /cns/ig-d/home/aredakov/david_dbm_propencities/advertisers_adx_revenue/data*;
  MATERIALIZE '/cns/ig-d/home/aredakov/david_dbm_propencities/advertisers_share_of_adxspend/data@50' AS
  ...
  DEFINE TABLE advertisers_revenue_xbid /cns/ig-d/home/aredakov/david_dbm_propencities/advertisers_revenue_xbid/data*;
  DEFINE TABLE advertisers_share_of_adxspend /cns/ig-d/home/aredakov/david_dbm_propencities/advertisers_share_of_adxspend/data*;
  MATERIALIZE '/cns/ig-d/home/aredakov/david_dbm_propencities/advertisers_shares/data@50' AS
  ...
  DEFINE TABLE ga_remarket_list_ids /cns/ig-d/home/aredakov/david_dbm_propencities/ga_remarket_list_ids/data*;
  DEFINE TABLE advertisers_shares /cns/ig-d/home/aredakov/david_dbm_propencities/advertisers_shares/data*;
  MATERIALIZE '/cns/ig-d/home/aredakov/david_dbm_propencities/advertisers_in_ga_nonga/data@1' AS
  ...
  DEFINE TABLE advertisers_in_ga_nonga /cns/ig-d/home/aredakov/david_dbm_propencities/advertisers_in_ga_nonga/data*;
  MATERIALIZE '/cns/ig-d/home/aredakov/david_dbm_propencities/advertisers_revenue_flags/data@50' AS
  ...
  # VIDEO non VIDEO
  MATERIALIZE '/cns/ig-d/home/aredakov/david_dbm_propencities/creativetype/data@50' AS
  ...
  DEFINE TABLE advertisers_revenue_flags /cns/ig-d/home/aredakov/david_dbm_propencities/advertisers_revenue_flags/data*;
  DEFINE TABLE creativetype /cns/ig-d/home/aredakov/david_dbm_propencities/creativetype/data*;
  MATERIALIZE '/cns/ig-d/home/aredakov/david_dbm_propencities/advertisers_revenue_flags_creativetype/data@50' AS
  ...
  MATERIALIZE '/cns/pa-d/home/aredakov/david_dbm_propencities/ga_dbm_user_list_id/data@1' AS
  ...
  DEFINE TABLE list_ids_ingadbm /cns/pa-d/home/aredakov/david_dbm_propencities/ga_dbm_user_list_id/data*;
  MATERIALIZE '/cns/ig-d/home/aredakov/david_dbm_propencities/remarketing_line_items/data@50' AS
  SELECT line_item_id
  FROM
  ...
  MATERIALIZE '/cns/ig-d/home/aredakov/david_dbm_propencities/xbid_lineitems/data@5000' AS
  ...
  DEFINE TABLE remarketing_line_items /cns/ig-d/home/aredakov/david_dbm_propencities/remarketing_line_items/data*;
  DEFINE TABLE xbid_lineitems /cns/ig-d/home/aredakov/david_dbm_propencities/xbid_lineitems/data*;
  MATERIALIZE '/cns/ig-d/home/aredakov/david_dbm_propencities/advertiser_id_in_remarketing/data@50' AS
  ...
  DEFINE TABLE advertisers_revenue_flags_creativetype /cns/ig-d/home/aredakov/david_dbm_propencities/advertisers_revenue_flags_creativetype/data*;
  DEFINE TABLE advertiser_id_in_remarketing /cns/ig-d/home/aredakov/david_dbm_propencities/advertiser_id_in_remarketing/data*;
  MATERIALIZE '/cns/ig-d/home/aredakov/david_dbm_propencities/data_for_r/data@50' AS
